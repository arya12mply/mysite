...
<html lang="en">
    ...
    <header>
        <nav>
            ...
            <li><button type ="button"><a href="#">HOBBIES</a></li>
    ...
    <div class ="intro"> 
       <a href ="#"> <img src = "arya.png"></a>
       <h1> haiiii i am arya.... my favorite hobbie is hearing <br> music... because i loves music...then another one is wall painting</h1>
    </div>
